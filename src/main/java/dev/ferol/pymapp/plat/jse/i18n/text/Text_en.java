 ...
 */
public final class Text_en extends I18nListResBundle {
    private static final Object[][] RESOURCE = {
        {"MOD_DISPLAYNAME", "PyMApp PLAT.mod - Java SE"},
        {"MOD_DESCRIPTION", "PyMApp platform module that implements integration and execution on a Java SE environment."},
    };
