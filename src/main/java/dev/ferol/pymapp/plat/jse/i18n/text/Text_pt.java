 ...
 */
public final class Text_pt extends I18nListResBundle {
    private static final Object[][] RESOURCE = {
        {"MOD_DISPLAYNAME", "PyMApp PLAT.mod - Java SE"},
        {"MOD_DESCRIPTION", "Módulo de plataforma do PyMApp que implementa a integração e a execução em um ambiente Java SE."},
    };
