 ...
 */
public final class Text_es extends I18nListResBundle {
    private static final Object[][] RESOURCE = {
        {"MOD_DISPLAYNAME", "PyMApp PLAT.mod - Java SE"},
        {"MOD_DESCRIPTION", "Módulo de plataforma de PyMApp que implementa la integración y ejecución sobre entorno Java SE."},
    };
