 ...
 */
public final class Text_ru extends I18nListResBundle {
    private static final Object[][] RESOURCE = {
        {"MOD_DISPLAYNAME", "PyMApp PLAT.mod - Java SE"},
        {"MOD_DESCRIPTION", "Платформенный модуль PyMApp, реализующий интеграцию и выполнение в среде Java SE."},
    };
