 ...
 */
public final class Text_fr extends I18nListResBundle {
    private static final Object[][] RESOURCE = {
        {"MOD_DISPLAYNAME", "PyMApp PLAT.mod - Java SE"},
        {"MOD_DESCRIPTION", "Module de plateforme PyMApp qui implémente l’intégration et l’exécution dans un environnement Java SE."},
    };
